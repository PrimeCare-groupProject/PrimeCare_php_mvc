...
<div style="max-width: 900px; margin: 0 auto; padding: 0 20px 40px;">
        ...
        <div style="padding: 25px 30px; border-bottom: 1px solid #eee;">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                <div>
                    ...
                    <div style="font-size: 16px; font-weight: 600; color: #333;"><?= $service->service_type ?? 'Maintenance Service' ?></div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div style="font-size: 16px; font-weight: 600; color: #333;"><?= $property->name ?? 'N/A' ?></div>
                </div>
                <div>
    ...
    <div style="background-color: #fff; border-radius: 15px; padding: 25px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.08);">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 20px;">
            <a href="<?= ROOT ?>/dashboard/serviceRequests" style="text-decoration: none; color: inherit;">
                <div style="background-color: #f8f9fa; border-radius: 10px; padding: 20px; transition: all 0.2s;" onmouseover="this.style.backgroundColor='#e9ecef';" onmouseout="this.style.backgroundColor='#f8f9fa';">
                    ...
                    <h4 style="margin: 0 0 10px; font-size: 16px;">View Your Service Requests</h4>
                    <p style="margin: 0; color: #666; font-size: 14px;">Check the status of your other service requests</p>
                </div>
            </a>
