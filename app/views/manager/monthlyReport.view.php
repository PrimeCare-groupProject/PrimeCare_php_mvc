...
<div class="user_view-menu-bar">
    <a href='<?= ROOT ?>/dashboard/managementhome/financeView'>
        <button class="back-btn"><img src="<?= ROOT ?>/assets/images/backButton.png" alt="Back" class="navigate-icons"></button>
    </a>
    <h2>Finance Report : <span style="color: var(--green-color)"></span></h2>
    <div class="flex-bar">
        <button onclick="generatePDF('Monthly_Finance_Report' , <?= date('Y-m') ?> )" class="small-btn orange">Download <i class="fa fa-download" style="margin-left: 5px;"></i></button>
    </div>
</div>
...
<!-- include the report -->
    <?php require_once APPROOT . '/reports/monthlyReport.report.php'; ?>
</div>
