    ...
    <div class="owner-addProp-container">
        <div class="owner-addProp-form-left">
            ...
            <div class="input-group">
                ...
                <div class="input-group-group" id="rent-basis-field">
                    ...
                    <input type="number" value="<?= $property->rental_price ?>" class="input-field" value="0">
                </div>
            </div>
        ...
        <div class="owner-addProp-form-right">
            ...
            <div class="input-group">
                ...
                <div class="input-group-group" id="rent-basis-field">
                    <label class="input-label" disabled>Monthly Rent In LKR</label>
                    <input type="number" value="<?= $propertyUpdate->rental_price ?>" class="input-field <?= check_equality($property, $propertyUpdate, 'rental_price') ? '' : 'not-equal' ?>" value="0">
                </div>
            </div>
