...
<div class="CP__button_container">
    <div class="CP__buttons">
        <button class="primary-btn" onclick="window.location.href='<?= ROOT ?>/dashboard/property/confirmUpdate/<?= $property->property_id ?>'">Accept Update</button>
        <button class="primary-btn red" onclick="window.location.href='<?= ROOT ?>/dashboard/property/rejectUpdate/<?= $property->property_id ?>'">Reject Update</button>
    </div>
</div>
