...
<body>
    <div class="user_view-container">
        <div class="header-line">
            ...
            <a href="<?= ROOT ?>/agent/profile"><img src="<?= get_img($_SESSION['user']->image_url) ?>" alt="Profile Picture" class="header-profile-picture"></a>
        </div>
        <div class="content-section">
            <div class="user_view-sidemenu">
                <ul>
                    ...
                    <li><a href="<?= ROOT ?>/dashboard/repairings"><button class="btn"><img src="<?= ROOT ?>/assets/images/repairrequests.png " alt="">Repairings</button></a></li>
