...
<body>
    ...
    <section class="header" id="home">
        <nav>
            ...
            <div class="nav-links" id="navlinks">
                ...
                <ul>
                    ...
                    <li><button class="header__button" onClick="window.location.href = 'login'">
                            Sign In | Log In
                        </button></li>
                </ul>
            </div>
        ...
        <div class="text-box">
            ...
            <p>Manage your properties effortlessly , offering </br>seamless Management,Maintenance, </br>and Rental servicesAll in one platform.</p>
