<div class="tenant-card">
    <div class="tenant-card-left">
        ...
        <div class="service-card-content">
            ...
            <div class="field-group">
                <div class="field-group">
                    <label class="service-card-label">Check-in:</label>
                    <span class="service-card-field">2024/07/26</span>
                </div>
                <div class="field-group">
                    <label class="service-card-label">Check-Out</label>
                    <span class="service-card-field">2024/12/25</span>
                </div>
            </div>
            <div class="field-group">
                <div class="field-group">
                    <label class="service-card-label">Booking Date:</label>
                    <span class="service-card-field">2024/07/26</span>
                </div>
                <div class="field-group">
                    <label class="service-card-label">No of People:</label>
